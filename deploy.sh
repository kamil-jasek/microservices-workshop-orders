...
docker build . -t "localhost:5000/orders:$PROJECT_VERSION"
docker push "localhost:5000/orders:$PROJECT_VERSION"
...
kubectl rollout status deployment/orders -n microservices-workshop
